...
ActiveRecord::Schema.define(:version => 20130721165236) do

  create_table "dynamicform_fields", :force => true do |t|
  ...
  create_table "dynamicform_values", :force => true do |t|
  ...
  create_table "dynamicforms", :force => true do |t|

...
Refinery::Images.configure do |config|
  ...
  # config.dragonfly_secret = "bd63c8621a09b4f4212cb94d418784bb8301c08736468e09"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/j_f_alameda/refinery-engine-test/vendor/extensions/refinerycms-dynamicfields/spec/dummy/public/system/refinery/images"
